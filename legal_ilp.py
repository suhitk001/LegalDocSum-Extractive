...
# F - facts (refers to the chronology of events that led to filing the case;)
# A - Arguments (arguments of the contend- ing parties;)
# S - Statute (Established laws referred to by the present court;)
# P - Precedent  (Precedents/prior cases that were referred to;)
# RPC - Ruling by Present Court (the final judgement given by the present court.)
# I - Issue - legal ques- tions/points being discussed,
# R - Ratio - rationale based on which the judgment is given, and
# RLC - Ruling by Lower Court: case documents from higher courts (e.g., Supreme Court) can contain de- cisions delivered at the lower courts (e.g. Tribunal),
#!/usr/bin/python3
...
# NLTK parts of speech tags abbr. explaination. 
